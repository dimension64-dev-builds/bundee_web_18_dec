    ...
    <>`
      <main className=" h-screen grid min-h-full  bg-primary/5 px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center">
          <p className="text-base font-semibold text-indigo-600">You'r favourite vehicle selections</p>
          {/* <div className="flex">
          ...
          <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Wishlists</h1>
