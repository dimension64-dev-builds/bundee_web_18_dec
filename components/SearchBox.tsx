        ...
        <>
            <div>
                <div className='relative z-50'>
                    ...
                    <div className={`absolute w-full z-10 mt-1 rounded-md overflow-auto max-h-56  p-1  bg-white px-2 py-1.5 text-xs font-medium text-foreground  shadow-lg border-t transition-opacity ease-in-out ${show && inputValue ? 'opacity-100  scale-1' : 'opacity-0  scale-0'}`} role='presentation'>
